...
public class REDIS_DB  // : MonoBehaviour
{
    ...
    private string globalConnectionString = "Server=ls-ce5399038c51311cbf1d9d5bfdef049493963c8d.cafcpcqvxqv2.us-west-2.rds.amazonaws.com:3306;Uid=dbmaster1;Database=Database-1;Pwd=dbmaster1;";
    ...
    public int testConnection2() {

        MySqlConnectionStringBuilder conn_string = new MySqlConnectionStringBuilder();
        //conn_string.Server = "ls - ce5399038c51311cbf1d9d5bfdef049493963c8d.cafcpcqvxqv2.us - west - 2.rds.amazonaws.com";
        conn_string.Server = "127.0.0.1";
        conn_string.Port = 3306;
        conn_string.UserID = "dbmaster1";
        conn_string.Password = "dbmaster1";
        conn_string.Database = "Database-1";
